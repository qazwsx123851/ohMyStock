"""quarterly_revenue_yoy — fundamental sub-scorer (3 pts, deferred stub).
...
@register_subscorer(category="fundamental", name="quarterly_revenue_yoy", max_points=3.0)
def quarterly_revenue_yoy(ctx: ScoringContext) -> SubScoreResult:
