"""broker_concentration — chip sub-scorer (7 pts, deferred stub).
...
@register_subscorer(category="chip", name="broker_concentration", max_points=7.0)
def broker_concentration(ctx: ScoringContext) -> SubScoreResult:
