...
Importing this package registers all 14 deferred stubs with the scoring
...
("Sub-scorer file layout under `subscorers/` package" — 14 stubs after
`rs_percentile` and `kline_patterns` were promoted to real sub-scorers).
"""
