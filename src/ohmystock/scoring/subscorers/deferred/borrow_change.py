"""borrow_change — chip sub-scorer (2 pts, deferred stub).
...
@register_subscorer(category="chip", name="borrow_change", max_points=2.0)
def borrow_change(ctx: ScoringContext) -> SubScoreResult:
