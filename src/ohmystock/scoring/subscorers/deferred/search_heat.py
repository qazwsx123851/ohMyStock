"""search_heat — sentiment sub-scorer (2 pts, deferred stub).
...
@register_subscorer(category="sentiment", name="search_heat", max_points=2.0)
def search_heat(ctx: ScoringContext) -> SubScoreResult:
    return SubScoreResult(
        ...
        max_points=2.0,
        status="skipped",
        evidence={"reason": "data source not implemented; negative-band scoring requires registry contract change"},
    )
