"""futures_oi — chip sub-scorer (3 pts, deferred stub).
...
@register_subscorer(category="chip", name="futures_oi", max_points=3.0)
def futures_oi(ctx: ScoringContext) -> SubScoreResult:
